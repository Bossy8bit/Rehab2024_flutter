...
class RatingWidget extends StatefulWidget {
  ...
  RatingWidget({required this.changeLanguage});
...
class RatingScreen extends StatelessWidget {
  ...
  RatingScreen({required this.changeLanguage});
        ...
        return Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 30), // ระยะห่างระหว่างแถวที่ 1 และแถวที่ 2
              ...
              SizedBox(height: 30), // ระยะห่างระหว่างแถวที่ 2 และปุ่ม Submit
